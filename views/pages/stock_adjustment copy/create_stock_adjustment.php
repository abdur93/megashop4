            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    ...
                    <tr><td><b>Adjustment Type:</b></td><td><?php echo StockAdjustmentType::html_select("cmbAdjustmentType"); ?></td></tr>
                  </table>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <button type="button" class="float-right" style="padding: 1px; margin-right: 5px;;"><a class="btn btn-success" href="manage-stock-adjustment">Manage Stock Adjustment</a></button>
       ...
       const cart=new Cart("adjustment");     
        ...
        $("#cmbWarehouse").on("change",function(){
           $.ajax({
             ...
             data:{"id":$(this).val()},
             success:function(res){
               $(".warehouse-info").html(res);;
             }
           });
        });

        //Show product other information

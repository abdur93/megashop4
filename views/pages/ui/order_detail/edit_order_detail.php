...
if(isset($_POST["btnUpdate"])){
	...
	$obj=new Order_detail($id,$order_id,$product_id,$qty,$price,$vat,$discount);
	$obj->update();
}
?>
<section class="content-header">
    ...
    <section class="content">     
     <div class="card"><form class='form-horizontal' action='edit-order_detail' method='post' enctype='multipart/form-data'><div class='card-header'>
				<a href='manage-order_detail' class='btn btn-success'>Manage Order_detail</a>
			</div>
				<div class='card-body'>
<?php
$html="";

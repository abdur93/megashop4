            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    <tr><td><b>Purchase ID:</b></td><td><input type="text" style="width:60px" value="<?php  echo $order->id;?>"  readonly/></td></tr>
                    <tr><td><b>Purchase Date:</b></td><td><input type="text" id="txtPurchaseDate" value=<?php echo $order->order_date;?> /></td></tr>
              ...
              <div class="row">
				...
				<table class="table table-striped">
                    ...
                    <tbody>                    
                      <?php
					     $order_details= PurchaseDetail::all_by($_POST["txtId"]);
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <button type="button" class="float-right" style="padding: 1px; margin-right: 5px;;"><a class="btn btn-success" href="purchases">Manage Purchase</a></button>

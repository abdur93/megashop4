            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                    <?php
                      echo Supplier::html_select("cmbCustomer");
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    <tr><td><b>Purchase ID:</b></td><td><input type="text" style="width:60px" value="<?php  echo Purchase::get_last_id()+1;?>"  readonly/></td></tr>
